                        ...
                        <div class="grid grid-cols-1 gap-6 px-8 text-center md:px-0 md:grid-cols-3">
                            <div class="overflow-hidden bg-white rounded-xl">
                                <div class="p-6">
                                    ...
                                    <p class="mt-6 text-lg font-medium text-gray-900">+91-98765-43210</p>
                                    <p class="mt-1 text-lg font-medium text-gray-900">+91-98765-43211</p>
                                </div>
                            </div>
                            ...
                            <div class="overflow-hidden bg-white rounded-xl">
                                <div class="p-6">
                                    ...
                                    <p class="mt-6 text-lg font-medium text-gray-900">contact@aspirefoundations.com</p>
                                    <p class="mt-1 text-lg font-m   edium text-gray-900">hr@aspirefoundations.com</p>
                                </div>
                            </div>
                            ...
                            <div class="overflow-hidden bg-white rounded-xl">
                                <div class="p-6">
                                    ...
                                    <p class="mt-6 text-lg font-medium leading-relaxed text-gray-900">Sarkhej Road, Near Prahlad Nagar Garden, Sector 17, Vastrapur, Ahmedabad - 380015, Gujarat, India</p>
                                </div>
                            </div>
                        </div>
                                ...
                                <form action="#" method="POST" class="mt-14">
                                    <div class="grid grid-cols-1 sm:grid-cols-2 gap-x-5 gap-y-4">
                                        ...
                                        <div>
                                            ...
                                            <div class="mt-2.5 relative">
                                                <input type="text" name="" id="" placeholder="Enter your company name" class="block w-full px-4 py-4 text-black placeholder-gray-500 transition-all duration-200 bg-white border border-gray-200 rounded-md focus:outline-none focus:border-blue-600 caret-blue-600" />
                                            </div>
                                        </div>
